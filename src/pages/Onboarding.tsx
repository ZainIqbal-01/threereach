      ...
      <div className="relative z-10 min-h-screen flex flex-col lg:flex-row">
        ...
        <div className="hidden lg:flex lg:w-[46%] xl:w-[44%] flex-col p-10 xl:p-14">
          <div className="flex-1 flex flex-col justify-center">
            <img src={logo} alt="Three Reach" className="h-20 w-auto object-contain mb-10 animate-fade-in select-none" draggable={false} />
        ...
        <div className="flex-1 flex items-center justify-center p-5 sm:p-8 lg:p-12">
          <div className="w-full max-w-[420px] animate-scale-in">
            ...
            <div className="lg:hidden text-center mb-6">
              <img src={logo} alt="Three Reach" className="h-16 w-auto object-contain mx-auto mb-4 select-none" draggable={false} />
              <StarAgent
