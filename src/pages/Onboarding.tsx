      ...
      <div className="w-full max-w-2xl">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center gap-4 mb-4">
            <img src={logo} alt="Three Reach" className="h-14" />
            <StarAgent 
              mood={isAnalyzing ? "scanning" : "waving"} 
              size={72} 
              message={isAnalyzing ? "Scanning AI engines for you..." : "Hi! Let's see how AI sees your brand ✨"}
            />
          </div>
        ...
        <div className="mt-8 grid grid-cols-3 gap-4 text-center">
          <div className="p-4">
            <div className="text-2xl font-bold text-primary mb-1">ChatGPT</div>
            <p className="text-sm text-muted-foreground">OpenAI's Assistant</p>
          </div>
          <div className="p-4">
            <div className="text-2xl font-bold text-primary mb-1">Gemini</div>
            <p className="text-sm text-muted-foreground">Google's AI</p>
          </div>
          <div className="p-4">
            <div className="text-2xl font-bold text-primary mb-1">Perplexity</div>
